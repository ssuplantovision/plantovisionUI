    ...
    return(
        ...
        <div className='Photo_center' >
          <div className='vw-100 app_up_block_Photo'>
            ...
            <h3 style={{fontSize:"20px"}}>Перед тем, как добавить новое исследование внимательно прочитайте инструкцию, чтобы оплучить более точный результат:</h3>
            <h3 style={{fontSize:"20px"}}>1. Снимок долежн быть сделан на плантоскопе.</h3>
            <h3 style={{fontSize:"20px"}}>2. На снимке должны быть видны ваши стопы под углом в 90 градусов.</h3>
            <h3 style={{fontSize:"20px"}}>3. Снимок должен быть достаточно хорошего качества, так как от него зависит результат.</h3>
            <h3 style={{fontSize:"20px"}}>После загрузки вашего изображения, результат появится в вашем личном кабинете, где вы сможете полностью посмотреть результат с пояснением. Приятного использования!</h3>
          </div>
